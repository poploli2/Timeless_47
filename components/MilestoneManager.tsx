  ...
  return (
    <div className="mt-6 w-full max-w-xs">
      <div className="flex items-center space-x-2 mb-3">
        ...
        <h3 className="font-bold text-love-800">重要日期</h3>
      </div>
      ...
      <div className="space-y-2 mb-4">
        ...
        {milestones.length === 0 && <p className="text-sm text-gray-400 italic text-center py-2">暂无日期。</p>}
      </div>

      {/* Add Form */}
      <form onSubmit={handleAdd} className="bg-white p-3 rounded-xl border border-love-100 shadow-sm">
        <p className="text-xs font-semibold text-love-400 uppercase mb-2">添加新日期</p>
        <div className="space-y-2">
          <input
            type="text"
            placeholder="事件名称（例如：初吻）"
            value={newTitle}
          ...
          <div className="flex space-x-2">
            ...
            >
              ...
              <option value="Special">特别日</option>
            </select>
